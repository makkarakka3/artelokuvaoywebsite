    ...
    import  "./PlasmicFaq.css" // plasmic-import: livmg6-q1O3q4/css
...
slot?: React.ReactNode
    ...
    function PlasmicFaq__RenderFunc(
      props: {
  ...
  <BaseCard
    ...
    className={classNames("__wab_instance", "Faq__root___3KFDu")}
  ...
  <p.Stack
    ...
    hasGap={true}
    className={classNames("plasmic_default__all", "plasmic_default__div", "Faq__box__mG0Hi")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "Faq__box___0ZmK8")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "Faq__box___1AuSr")}
    
    >
          <p.PlasmicSlot
      defaultContents={"Are there long-term contracts?"}
      value={args.children}
      className={classNames("Faq__slotChildren___57B07")} />
        </div>
  
        </div>
  
<p.PlasmicSlot
      defaultContents={"Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."}
      value={args.slot}
      className={classNames("Faq__slotSlot__k985X")} />
        </p.Stack>
    ...
    type NodeOverridesType<T extends NodeNameType> = Pick<PlasmicFaq__OverridesType, DescendantsType<T>>;
