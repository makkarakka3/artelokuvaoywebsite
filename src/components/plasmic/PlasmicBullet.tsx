    ...
    import  "./PlasmicBullet.css" // plasmic-import: EkaXiy9fMKhqG/css
  
    import Done24Pxsvg2Icon from "./PlasmicIcon__Done24Pxsvg2";  // plasmic-import: uCX7bF9ktrIar/icon
...
svg?: p.Flex<"svg">;
    ...
    function PlasmicBullet__RenderFunc(
      props: {
  ...
  <p.Stack
    ...
    hasGap={true}
    className={classNames("plasmic_default__all", "plasmic_default__div", "root_reset_QijKjBjMCAKhTPs42ygrD", "Bullet__root__edSpA")}
  ...
  <Done24Pxsvg2Icon
    ...
    className={classNames("plasmic_default__all", "plasmic_default__svg", "Bullet__svg__lzDr5")}
role={"img"}
...
svg: "svg"
    ...
    type NodeOverridesType<T extends NodeNameType> = Pick<PlasmicBullet__OverridesType, DescendantsType<T>>;
