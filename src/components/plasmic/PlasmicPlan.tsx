    ...
    import BaseCard from "..//BaseCard";  // plasmic-import: gdae9KdTaPsIf/component
import Bullet from "..//Bullet";  // plasmic-import: EkaXiy9fMKhqG/component
import LinkButton from "..//LinkButton";  // plasmic-import: 9LofeW3xwMYT/component
    ...
    import  "./PlasmicPlan.css" // plasmic-import: nSQv7iLNTjcL_/css
...
children?: React.ReactNode
  ...
  <BaseCard
    ...
    className={classNames("__wab_instance", "Plan__root__tvgtr")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "Plan__box___1HqNa")}
  ...
  <p.Stack
    ...
    hasGap={true}
    className={classNames("plasmic_default__all", "plasmic_default__div", "Plan__box__gPOt")}
    
    >
          <p.PlasmicSlot
      defaultContents={"Basic"}
      value={args.name}
      className={classNames("Plan__slotName__iPCrE")} />
<p.PlasmicSlot
      defaultContents={
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "__wab_text", "Plan__box__mAfo")}
...
<p.PlasmicSlot
  ...
  <p.Stack
    ...
    hasGap={true}
    className={classNames("plasmic_default__all", "plasmic_default__div", "Plan__box__piYZh")}
  ...
  <Bullet
    ...
    className={classNames("__wab_instance", "Plan__bullet__cbFMx")}
  ...
  <Bullet
    ...
    className={classNames("__wab_instance", "Plan__bullet___8PqZ2")}
  ...
  <Bullet
    ...
    className={classNames("__wab_instance", "Plan__bullet__ac7Tj")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "Plan__box__qtsP3")}
