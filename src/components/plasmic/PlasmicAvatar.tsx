    ...
    import  "./PlasmicAvatar.css" // plasmic-import: O0uBJ5DBtN6X3/css
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "root_reset_QijKjBjMCAKhTPs42ygrD", "Avatar__root__d7Xg")}
