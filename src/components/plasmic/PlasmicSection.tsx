    ...
    import  "./PlasmicSection.css" // plasmic-import: AVw91yGjjMxp/css
...
title?: React.ReactNode
  ...
  <p.Stack
    ...
    hasGap={true}
    className={classNames("plasmic_default__all", "plasmic_default__div", "root_reset_QijKjBjMCAKhTPs42ygrD", "Section__root__polVl")}
    
    >
          <p.PlasmicSlot
      defaultContents={"Trusted by over 20,000 companies all over the world"}
      value={args.title}
      className={classNames("Section__slotTitle__hifCp")} />
<p.PlasmicSlot
      defaultContents={"Arcu cursus vitae congue mauris rhoncus viverra nibh cras pulvinar mattis blandit libero cursus mattis."}
      value={args.subtitle}
      className={classNames("Section__slotSubtitle__zB5Zw")} />
        </p.Stack>
