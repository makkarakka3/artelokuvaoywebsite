    ...
    import  "./PlasmicFeatureCard.css" // plasmic-import: Yt2TFc4Qu7On/css
...
_long?: SingleBooleanChoiceArg<"_long">
  ...
  <p.Stack
    ...
    hasGap={true}
    className={classNames("plasmic_default__all", "plasmic_default__div", "root_reset_QijKjBjMCAKhTPs42ygrD", "FeatureCard__root___4J5Af", { "FeatureCard__root___long___4J5AfLMnoS": hasVariant(variants, "_long", "_long") })}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "FeatureCard__box__tmr9U", { "FeatureCard__box___long__tmr9UlMnoS": hasVariant(variants, "_long", "_long") })}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "FeatureCard__box__rizzl", { "FeatureCard__box___long__rizzllMnoS": hasVariant(variants, "_long", "_long") })}
  ...
  <svg
    ...
    className={classNames("plasmic_default__all", "plasmic_default__svg", "FeatureCard__svg__pckVo")}
role={"img"}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "FeatureCard__box__o6IzW", { "FeatureCard__box___long__o6IzWlMnoS": hasVariant(variants, "_long", "_long") })}
    
    >
          <p.PlasmicSlot
      defaultContents={"Title"}
      value={args.title}
      className={classNames("FeatureCard__slotTitle__fe1QQ", { "FeatureCard__slotTitle___long__fe1QQlMnoS": hasVariant(variants, "_long", "_long") })} />
<p.PlasmicSlot
      defaultContents={"Lorem ipsum dolor sit amet, consectetur adipiscing elit."}
      value={args.description}
      className={classNames("FeatureCard__slotDescription__natdw", { "FeatureCard__slotDescription___long__natdwlMnoS": hasVariant(variants, "_long", "_long") })} />
        </div>
...
{ (hasVariant(variants, "_long", "_long") ? true : false) ? (
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "FeatureCard__box___1PVtV", { "FeatureCard__box___long___1PVtVlMnoS": hasVariant(variants, "_long", "_long") })}
  ...
  <svg
    ...
    className={classNames("plasmic_default__all", "plasmic_default__svg", "FeatureCard__svg__t3OXz")}
role={"img"}
